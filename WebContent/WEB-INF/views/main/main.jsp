        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="index.html" class="site_title"><i class="fa fa-paw"></i> <span>조한솔</span></a>
            </div>
            ...
            <div class="profile">
              <div class="profile_pic">
                <img src="images/img.jpg" alt="${pageContext.request.contextPath}." class="img-circle profile_img">
              </div>
