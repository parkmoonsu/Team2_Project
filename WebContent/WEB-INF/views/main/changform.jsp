								...
								<div class="x_content">
									<div class="col-md-3 col-sm-3 col-xs-12 profile_left">
										...
										<ul class="list-unstyled user_data">
											<li><i class="fa fa-openid user-profile-icon"></i>&nbsp;&nbsp;${dto.m_id}
											</li>
											<li><i class="fa fa-briefcase user-profile-icon"></i>&nbsp;&nbsp;${dto.j_name}
											</li>
											<li><c:choose>
											...
											<li class="m-top-xs"><i
												class="fa fa-external-link user-profile-icon"></i>&nbsp;&nbsp;${dto.m_email}
											</li>
											<li><i class="fa fa-phone user-profile-icon"></i>&nbsp;&nbsp;&nbsp;${dto.m_phone}
											</li>
				...
				<div id="div-forms">
					...
					<form id="login-form" action="" method="post">
						...
						<div class="modal-footer">
							<div>
								<a href="redirect:/ChangeForm.htm"><button type="submit"
										class="btn btn-success" data-dismiss="modal">완료</button></a>
							</div>
						</div>
					</form>
					<!-- End # Login Form -->
