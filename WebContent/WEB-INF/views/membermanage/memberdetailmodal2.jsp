      ...
      <div class="modal-body">
         ...
         <!--   <div class="control-label col-md-2 col-sm-2 col-xs-1">
           ...
           <label class="control-label col-md-1 col-sm-2 col-xs-2">ID</label> 
            <div class="col-md-5 col-sm-4 col-xs-4 form-group has-feedback">
               <input type="text" class="form-control has-feedback-left"
               id="inputSuccess3" value="${dto2.m_id }" readonly> 
            ...
            <div class="col-md-5 col-sm-4 col-xs-4 form-group has-feedback">
               <input type="text" class="form-control has-feedback-left"
                  id="inputSuccess4" value="${dto2.m_addr }" readonly> 
            ...
            <div class="col-md-5 col-sm-4 col-xs-4 form-group has-feedback">
               <input type="text" class="form-control has-feedback-left"
                id="inputSuccess5" value="${dto2.m_daddr }" readonly> 
                 <span
            ...
            <br>
               ...
               <div class="form-group">
                 <label class="control-label col-md-2 col-sm-2 col-xs-2">등급</label> 
                     <div class="col-md-4 col-sm-4 col-xs-3">
                        <input type="text" class="form-control has-feedback-left" value="${dto2.j_name }" readonly>
               ...
               <div class="col-md-5 col-sm-4 col-xs-4">
                     <input type="text" class="form-control has-feedback-left" value="${dto2.m_email }" readonly>
