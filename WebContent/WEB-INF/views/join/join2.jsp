...
<script type="text/javascript"
	src="${pageContext.request.contextPath}/js/bootstrap-filestyle.js"></script>
										...
										<div id="wizard" class="form_wizard wizard_horizontal">
											<ul class="wizard_steps">
												<li><a href="#step-2"> <span class="step_no">1</span>
														<span class="step_descr" style="color: black"> Step
															1<br /> <small style="color: black"> 약관동의</small>
													</span>
												</a></li>
												<li><a href="#step-2"> <span class="step_no">2</span>
														<span class="step_descr" style="color: black"> Step
															2<br /> <small style="color: black"> 정보작성</small>
													</span>
												</a></li>
												<li><a href="#step-2"> <span class="step_no">3</span>
														<span class="step_descr" style="color: black"> Step
															3<br /> <small style="color: black"> 가입완료</small>
													</span>
												</a></li>
											...
											<div id="step-2" style="text-align: center;" class="my-box">
												<form id="register" class="form-horizontal form-label-left"
													...
													<div class="form-group">
														...
														<div class="col-md-2 col-sm-2 col-xs-12">
															<div id="m_gender" class="btn-group"
																data-toggle="buttons">
																<label class="btn btn-default"
																	...
																	data-toggle-class="btn-primary"
																	data-toggle-passive-class="btn-default"> <input
																	type="radio" name="m_gender" value="female"> 여성
																</label>
													...
													<div class="form-group">
														...
														<div class="col-md-5 col-sm-5 col-xs-12">
															<input id="m_photo" onchange="imagecheck(this)"
																name="files[0]" type="file" class="filestyle"
																data-buttonText="Open" data-input="false"
																data-iconName="glyphicon-plus"
													...
													<div class="form-group">
														...
														<div class="col-md-5 col-sm-5 col-xs-12">
															<input id="m_photo2" onchange="imagecheck(this)"
																name="files[1]" type="file" class="filestyle"
																data-buttonText="Open" data-input="false"
																data-iconName="glyphicon-plus"
																data-classButton="btn btn-primary">
													...
													<div class="form-group">
														...
														<div class="col-md-5 col-sm-5 col-xs-12">
															<input id="m_resume" onchange="xlscheck(this)"
																name="files[2]" type="file" class="filestyle"
																data-buttonText="Open" data-input="false"
																data-iconName="glyphicon-plus"
																data-classButton="btn btn-primary">
														</div>
												...
												<div id = "plus">
													...
													<div style="float: right; margin: 30px;">
														<input type="button" value="이전" class="btn btn-primary"
															...
															type="submit" value="다음" class="btn btn-success"
															id="next">
													</div>
												</form>
