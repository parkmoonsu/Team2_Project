										...
										<div id="step-1" style="text-align: center;" class="my-box">
											...
											<div class="form-group" style="padding: 25px">
												...
												<p style="text-align: left">
													정보통신망법 규정에 따라 KOSBUS에 회원가입 신청하시는 분께 수집하는 개인정보의 항목, 개인정보의 수집 및 이용목적, 개인정보의 보유 및 이용기간을 안내 드리오니 자세히 읽은 후 동의하여 주시기 바랍니다.<br>
											...
											<div class="my-box" style="height: 150px; overflow: scroll; overflow-x: hidden;">
												<p>
													...
													<p>이 약관은 네이버 주식회사 (이하 “회사”)가 제공하는 위치정보사업 또는 위치기반서비스사업과 관련하여 회사와 개인위치정보주체와의 권리, 의무 및 책임사항, 기타 필요한 사항을 규정함을 목적으로 합니다.
