										...
										<div id="step-1" style="text-align: center;" class="my-box">
											...
											<div class="form-group" style="padding: 25px">
												<div class="my-box" style="height: 150px;overflow: scroll; overflow-x: hidden;">
													...
													<h5 style="font-weight:bold; text-align: left;">제 2 조 (정의)</h5>
													...
													<br><h5 style="font-weight:bold; text-align: left;">제 3 조 (약관의 게시와 개정)</h5>
													...
													<br><h5 style="font-weight:bold; text-align: left;">제 4 조 (약관의 해석)</h5>
													...
													<br><h5 style="font-weight:bold; text-align: left;">제 5 조 (이용계약 체결)</h5>
													...
													<br><h5 style="font-weight:bold; text-align: left;">제 6 조 (회원정보의 변경)</h5>
													...
													<br><h5 style="font-weight:bold; text-align: left;">제 7 조 (개인정보보호 의무)</h5>
													...
													<br><h5 style="font-weight:bold; text-align: left;">제 8 조 ("회원"의 "아이디" 및 "비밀번호"의 관리에 대한 의무)</h5>
													...
													<br><h5 style="font-weight:bold; text-align: left;">제 9 조 ("회원"에 대한 통지)</h5>
													...
													<br><h5 style="font-weight:bold; text-align: left;">제 10 조 ("회사"의 의무)</h5>
											...
											<div class="my-box" style="height: 150px; overflow: scroll; overflow-x: hidden;">
												<p>
													...
													<p>회사는 다음과 같이 위치정보 관리책임자를 지정하여 이용자들이 서비스 이용과정에서 발생한 민원사항 처리를 비롯하여 개인위치정보 주체의 권리 보호를 위해 힘쓰고 있습니다.
													위치정보 관리책임자 : (개인)정보보호 담당 부서 임원(개인정보 보호책임자 겸직)
													전화번호 : 1588-3820
													이메일 주소 : privacy@kosbus.com
