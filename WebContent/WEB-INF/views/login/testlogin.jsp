			...
			<nav class="navbar navbar-default">
				<div class="navbar-header">
					<a href="#" class="js-fh5co-nav-toggle fh5co-nav-toggle"
						...
						aria-controls="navbar"></a> <a class="navbar-brand" href="bus.htm">KosBus</a>
				</div>
					...
					<div class="col-sm-5 col-sm-offset-3 form-box">
						...
						<div class="form-bottom">
							<form role="form"
								...
								name="f" class="login-form">

								<div class="form-group">
									<div style="float:left" class="sm-col-3">
								...
								<div class="col-sm-6 col-xs-12" style="padding-right: 5px">
									<a href="search.htm" class="btn btn-primary btn-sm btn-link">아이디/비밀번호찾기</a>
								</div>

								<div class="col-sm-6 col-xs-12" style="padding-left: 3px">
									<a href="join.htm" class="btn btn-primary btn-sm btn-link">회원가입</a>
								</div>
