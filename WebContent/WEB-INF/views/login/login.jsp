											...
											<div class="form-top-center">
												...
												<div class="form-bottom">
													<form role="form"
														...
														method="post" name="f" class="login-form"
														...
														<div class="form-group">
															...
															<br> <input type="submit"
																class="btn btn-primary btn-lg btn-block" value="로그인">
															<br>
															<div class="col-xs-6 col-sm-6" align="center">
																<a href="search.htm"
																	class="btn btn-primary btn-sm btn-block">아이디/비밀번호찾기</a>
															</div>
															<div class="col-xs-6 col-sm-6" align="center">
																<a href="join.htm"
																	class="btn btn-primary btn-sm btn-block">회원가입</a>
															</div>
														</div>
													</form>
				...
				<div id="div-forms">
					...
					<form id="login-form" action="" method="post">
						<div class="modal-body">
							...
							<input id="login_username" name="username" class="form-control"
								type="text" placeholder="인증번호 입력" required>
						</div>
						<div class="modal-footer">
							<div>
								<a href="redirect:/join.htm"><button type="submit"
										class="btn btn-primary btn-lg btn-block">완료</button></a>
							</div>
						</div>
					</form>
					<!-- End # Login Form -->
